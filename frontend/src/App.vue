                ...
                <v-row>
                        ...
                        >
                            <v-list-item>
                                ...
                                ><span class="material-symbols-outlined" style="font-size:60px; color:#9575CD;">inspection</span>
                                </v-list-item-avatar>
                            </v-list-item>
                        ...
                        >
                            <v-list-item>
                                <v-list-item-avatar 
                                    ...
                                    size="80"
                                    style="margin-top:80px;"
                                ><span class="material-symbols-outlined" style="font-size:60px; color:#9575CD;">payment</span>
                                </v-list-item-avatar>
                            </v-list-item>
